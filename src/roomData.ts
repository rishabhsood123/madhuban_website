...
export const rooms: RoomDetail[] = [
  {
    ...
    images: [
      `${BASE}assets/rooms/orchard-room/1.png`,
      `${BASE}assets/rooms/orchard-room/2.png`,
      `${BASE}assets/rooms/orchard-room/3.png`,
      `${BASE}assets/rooms/orchard-room/4.png`,
      `${BASE}assets/rooms/orchard-room/5.png`,
    ],
    heroImage: `${BASE}assets/orchard_room.png`,
  },
  {
    id: 'valley-room',
    name: 'Valley Room',
